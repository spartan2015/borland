...
USEFORM("Unit18.cpp", automatizare);
USEFORM("Unit19.cpp", meter);
USEFORM("Unit20.cpp", pontaj);
USEFORM("Unit21.cpp", sarbatorilegale);
USEFORM("D:\IMAGE\GRAPHICS\BMPS\OFFCTLBR\SMALL\COLOR\Unit22.cpp", raport_pontaj);
//---------------------------------------------------------------------------
WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
        try
        {
                 ...
                 Application->CreateForm(__classid(Tautomatizare), &automatizare);
                 Application->CreateForm(__classid(Tmeter), &meter);
                 Application->CreateForm(__classid(Tpontaj), &pontaj);
                 Application->CreateForm(__classid(Tsarbatorilegale), &sarbatorilegale);
                 Application->CreateForm(__classid(Traport_pontaj), &raport_pontaj);
                 Application->Run();
        }
