...
D1->pontaj->TableName="p"+StringReplace(DBEdit1->Field->AsString," ","z", Flags);
D1->pontaj->CreateTable();
  }
}
//---------------------------------------------------------------------------
...
void __fastcall TMainFrame::AdminClick(TObject *Sender)
{
if (Admin->Checked)  {
...
else PasswordDlg->ShowModal();
}
//---------------------------------------------------------------------------


void __fastcall TMainFrame::automatizare01Execute(TObject *Sender)
{
automatizare->Show();
automatizare->Label1->Caption=D1->Table1Nume_firma->AsString;        
}
//---------------------------------------------------------------------------

void __fastcall TMainFrame::pontaj01Execute(TObject *Sender)
{
TReplaceFlags Flags;
Flags <<rfReplaceAll;
Hide();
pontaj->Show();
pontaj->Label1->Caption=D1->Table1Nume_firma->AsString;
D1->pontaj->TableName="p"+StringReplace(DBEdit1->Field->AsString," ","z", Flags);
D1->pontaj->Active=true;
}
//---------------------------------------------------------------------------

void __fastcall TMainFrame::BitBtn2Click(TObject *Sender)
{
D1->Table1->Close();
