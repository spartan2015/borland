...
USEFORM("Unit26.cpp", platafactura);
USEFORM("Unit27.cpp", biosvaluta);
USEFORM("D:\IMAGE\GRAPHICS\BMPS\Unit29.cpp", raport_factura_valuta);
USEFORM("Unit28.cpp", cproduse);
USEFORM("Unit30.cpp", cservicii);
USEFORM("Unit31.cpp", cnew);
//---------------------------------------------------------------------------
...
WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
       ...
       splash->Update();
                 ...
                 Application->CreateForm(__classid(Tplatafactura), &platafactura);
                 Application->CreateForm(__classid(Tbiosvaluta), &biosvaluta);
                 Application->CreateForm(__classid(Traport_factura_valuta), &raport_factura_valuta);
                 Application->CreateForm(__classid(Tcproduse), &cproduse);
                 Application->CreateForm(__classid(Tcservicii), &cservicii);
                 Application->CreateForm(__classid(Tcnew), &cnew);
                 splash->Hide();
                 splash->Close();
                 Application->Run();
        }
