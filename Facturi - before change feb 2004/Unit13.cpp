...
if (DBMemo1->Lines->Count==0){
        dm->cb->Edit();
        if (dm->cbio->AsString=="intrare") dm->cbsuma_intrare_disponibila->AsFloat=dm->cbintrare->AsFloat;
        if (dm->cbio->AsString=="iesire") dm->cbsuma_iesire_disponibila->AsFloat=dm->cbiesire->AsFloat;
        dm->cb->Post();
        }
...
{
if (DBComboBox1->Text=="intrari") {
        DBEdit9->DataField="intrari";
        DBEdit6->DataField="valuta_intrare";
        }
if (DBComboBox1->Text=="iesiri"){
        DBEdit9->DataField="iesiri";
